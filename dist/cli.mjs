...
var require_windows = __commonJS({
  "../langvision/js/node_modules/isexe/windows.js"(exports, module) {
    "use strict";
...
var require_mode = __commonJS({
  "../langvision/js/node_modules/isexe/mode.js"(exports, module) {
    "use strict";
    module.exports = isexe;
    isexe.sync = sync;
    var fs = __require("fs");
...
var require_path_key = __commonJS({
  "../langvision/js/node_modules/path-key/index.js"(exports, module) {
    "use strict";
...
var require_escape = __commonJS({
  "../langvision/js/node_modules/cross-spawn/lib/util/escape.js"(exports, module) {
    "use strict";
...
var require_shebang_regex = __commonJS({
  "../langvision/js/node_modules/shebang-regex/index.js"(exports, module) {
    "use strict";
    module.exports = /^#!(.*)/;
  }
});
...
var require_shebang_command = __commonJS({
  "../langvision/js/node_modules/shebang-command/index.js"(exports, module) {
    "use strict";
...
var require_enoent = __commonJS({
  "../langvision/js/node_modules/cross-spawn/lib/enoent.js"(exports, module) {
    "use strict";
    var isWin = process.platform === "win32";
...
var require_cross_spawn = __commonJS({
  "../langvision/js/node_modules/cross-spawn/index.js"(exports, module) {
    "use strict";
...
var require_merge_stream = __commonJS({
  "../langvision/js/node_modules/merge-stream/index.js"(exports, module) {
    "use strict";
...
var require_windows2 = __commonJS({
  "../langtune/js/node_modules/isexe/windows.js"(exports, module) {
    "use strict";
    module.exports = isexe;
    isexe.sync = sync;
    var fs = __require("fs");
...
var require_mode2 = __commonJS({
  "../langtune/js/node_modules/isexe/mode.js"(exports, module) {
    "use strict";
    module.exports = isexe;
    isexe.sync = sync;
    var fs = __require("fs");
...
var require_path_key2 = __commonJS({
  "../langtune/js/node_modules/path-key/index.js"(exports, module) {
    "use strict";
    var pathKey3 = (options = {}) => {
      const environment = options.env || process.env;
      const platform = options.platform || process.platform;
...
var require_escape2 = __commonJS({
  "../langtune/js/node_modules/cross-spawn/lib/util/escape.js"(exports, module) {
    "use strict";
    var metaCharsRegExp = /([()\][%!^"`<>&|;, *?])/g;
    function escapeCommand(arg) {
      arg = arg.replace(metaCharsRegExp, "^$1");
...
var require_shebang_regex2 = __commonJS({
  "../langtune/js/node_modules/shebang-regex/index.js"(exports, module) {
    "use strict";
    module.exports = /^#!(.*)/;
  }
});
...
var require_shebang_command2 = __commonJS({
  "../langtune/js/node_modules/shebang-command/index.js"(exports, module) {
    "use strict";
...
var require_enoent2 = __commonJS({
  "../langtune/js/node_modules/cross-spawn/lib/enoent.js"(exports, module) {
    "use strict";
    var isWin = process.platform === "win32";
    function notFoundError(original, syscall) {
      return Object.assign(new Error(`${syscall} ${original.command} ENOENT`), {
...
var require_cross_spawn2 = __commonJS({
  "../langtune/js/node_modules/cross-spawn/index.js"(exports, module) {
    "use strict";
    var cp = __require("child_process");
...
var require_merge_stream2 = __commonJS({
  "../langtune/js/node_modules/merge-stream/index.js"(exports, module) {
    "use strict";
    var { PassThrough } = __require("stream");
    module.exports = function() {
      var sources = [];
...
var findSignalByNumber = (number, signals3) => {
  const signal = signals3.find(({ name }) => constants2.signals[name] === number);
  if (signal !== void 0) {
    return signal;
  }
...
var npmRunPathEnv2 = ({ env = process7.env, ...options } = {}) => {
  env = { ...env };
...
import { constants as constants4 } from "os";
...
var findSignalByNumber2 = (number, signals3) => {
  const signal = signals3.find(({ name }) => constants4.signals[name] === number);
  if (signal !== void 0) {
    return signal;
  }
  return signals3.find((signalA) => signalA.number === number);
...
var makeError2 = ({
  ...
  isCanceled,
  killed,
  parsed: { options: { timeout, cwd = process8.cwd() } }
}) => {
  exitCode = exitCode === null ? void 0 : exitCode;
  signal = signal === null ? void 0 : signal;
...
import { ChildProcess as ChildProcess3 } from "child_process";
...
// ../langtune/js/node_modules/execa/lib/pipe.js
var isExecaChildProcess2 = (target) => target instanceof ChildProcess3 && typeof target.then === "function";
var pipeToTarget2 = (spawned, streamName, target) => {
  if (typeof target === "string") {
    spawned[streamName].pipe(createWriteStream2(target));
    return spawned;
  }
...
import { createReadStream as createReadStream2, readFileSync as readFileSync2 } from "fs";
...
var getInput2 = ({ input, inputFile }) => {
  ...
  validateInputOptions2(input);
  return createReadStream2(inputFile);
};
...
import { ChildProcess as ChildProcess4 } from "child_process";
...
var parseExpression2 = (expression) => {
  ...
  if (typeOfExpression === "object" && expression !== null && !(expression instanceof ChildProcess4) && "stdout" in expression) {
    const typeOfStdout = typeof expression.stdout;
    if (typeOfStdout === "string") {
      return expression.stdout;
    }
    if (Buffer4.isBuffer(expression.stdout)) {
      return expression.stdout.toString();
    }
    throw new TypeError(`Unexpected "${typeOfStdout}" stdout in template expression`);
  }
...
var verboseDefault2 = debuglog2("execa").enabled;
...
var logCommand2 = (escapedCommand, { verbose }) => {
  ...
  process10.stderr.write(`[${getTimestamp2()}] ${escapedCommand}
`);
};
...
var getEnv2 = ({ env: envOption, extendEnv, preferLocal, localDir, execPath }) => {
  const env = extendEnv ? { ...process11.env, ...envOption } : envOption;
  if (preferLocal) {
...
var handleArguments2 = (file, args, options = {}) => {
  ...
  if (process11.platform === "win32" && path4.basename(file, ".exe") === "cmd") {
    args.unshift("/q");
  }
  return { file, args, options, parsed };
};
var handleOutput2 = (options, value, error) => {
  if (typeof value !== "string" && !Buffer5.isBuffer(value)) {
    return error === void 0 ? void 0 : "";
  }
  if (options.stripFinalNewline) {
...
function execaSync2(file, args, options) {
  ...
  let result;
  try {
    result = childProcess2.spawnSync(parsed.file, parsed.args, { ...parsed.options, input });
  } catch (error) {
    throw makeError2({
      error,
      stdout: "",
